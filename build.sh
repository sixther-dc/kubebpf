...
docker exec erda-ebpf-devel /bin/bash -c "cd /root/bpf_prog/;clang -D__KERNEL__ -D__ASM_SYSREG_H -Wno-unused-value -Wno-pointer-sign -Wno-compare-distinct-pointer-types -Wunused -Wall -Werror -O2 -g -target bpf -c main.bpf.c -o main.bpf.o"
